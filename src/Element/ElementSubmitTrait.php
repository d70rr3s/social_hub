 ...
 *
 * Allows form elements to use #element_submit, a substitute
 ...
 */
trait ElementSubmitTrait {

  /**
   * Attaches the #element_submit functionality.
   *
   * @param array $element
  ...
  public static function attachElementSubmit(array $element, FormStateInterface $form_state, array &$complete_form) {
    if (isset($complete_form['#element_submit_attached'])) {
      return $element;
    }
    ...
    $complete_form['#element_submit_attached'] = TRUE;

    return $element;
  }

  /**
   * Confirms that #element_submit handlers can be run.
   *
   * @param array $element
   *   The form element.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   ...
   * the #element_submit handlers either in the last step of
  ...
  /**
   * Calls the #element_submit callbacks recursively.
   *
   * @param array &$element
   *   The current element.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
